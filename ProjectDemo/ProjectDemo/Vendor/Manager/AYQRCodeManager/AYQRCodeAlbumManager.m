...
#import "AYQRCodeAlbumManager.h"
#import <AVFoundation/AVFoundation.h>
#import <Photos/Photos.h>

#import "UIImage+AYImageSize.h"

@interface AYQRCodeAlbumManager() <UINavigationControllerDelegate, UIImagePickerControllerDelegate>
...
@implementation AYQRCodeAlbumManager

static AYQRCodeAlbumManager *_instance;
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary<NSString *,id> *)info
{
    ...
    if (features.count == 0) {
        [self.currentVC dismissViewControllerAnimated:YES completion:^{
            if (weakSelf.delegate && [weakSelf.delegate respondsToSelector:@selector(QRCodeAlbumManager:didFinishPickingMediaWithResult:)]) {
                [weakSelf.delegate QRCodeAlbumManager:weakSelf didFinishPickingMediaWithResult:weakSelf.detectorString];
            }
        }];
        return;
